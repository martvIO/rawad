...
import { getEnv } from "../adapters/env.js";

// Snapshot the injected env once at module load. The platform (web initAdapters,
// native app entry, vitest setup) calls setEnv() before this module is evaluated,
// so the build-time values below resolve exactly as they did from import.meta.env.
const ENV = getEnv();
...
export const SSE_BASE_URL =
  (ENV.VITE_SSE_BASE_URL ?? "https://api-je74slt7ra-uc.a.run.app").replace(/\/$/, "");
...
export const CONTACT = {
  WHATSAPP: ENV.VITE_CONTACT_WHATSAPP ?? "972529348797",
