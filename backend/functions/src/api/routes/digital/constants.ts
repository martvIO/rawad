...
const THEME_COLORS = new Set([
  ...
  "royalGold", "royalGoldNoir", "royalGoldIvory",
]);
...
const TEMPLATE_IDS = new Set(["classic", "destination-love", "dolce-vita", "sacred-garden", "blossom-oud", "gilded-orchard", "lumen", "royal-gold"]);
