  ...
  const renderConf = (conf) => {
    ...
    return (
      <div key={conf.id} style={{
          ...
          <div style={{ fontSize: 11, color: "#7a6a4a" }}>
            {isUnknown ? (
              ...
              <>
                ...
                <span style={{ color: "#c9a84c", fontWeight: 700, direction: "ltr" }}>{conf.groomUsername}</span>
              </>
            )}
          </div>
        ...
        {isUnknown && (
          <div style={{ fontSize: 11, color: "#7a6a4a", marginBottom: 8 }}>
            {t("admin_conf_for_groom")}{" "}
            <span style={{ color: "#c9a84c", fontWeight: 700, direction: "ltr" }}>{conf.groomUsername}</span>
          </div>
        )}
