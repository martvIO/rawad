// Venue section — faux themed map, address/access rows, nearby hotels, and a
// real Google Maps deep link.
import { Num } from "../../Num.jsx";
import { SectionHead, ON_GOLD } from "../inviteShared.jsx";

export function VenueSection({ venue, venueCity, venueAddress, accessNote, hotels, theme, font, lang }) {
