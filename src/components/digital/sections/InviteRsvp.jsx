// RSVP — attendance toggle, phone, party size, meal preference, song request,
// note, and the celebratory confetti/hearts success state. The submit payload
// shape is a frozen contract with POST /api/invites/digital/submit.
import { useEffect, useState } from "react";
import { Num } from "../../Num.jsx";
import { SectionHead, ON_GOLD } from "../inviteShared.jsx";
...
export function RSVPSection({ theme, font, lang, opts, mealOptions, guestPhone, onSubmitRsvp, disabled, alreadyAnswered, rsvpDone }) {
