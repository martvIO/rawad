// Invitation footer (flourish + wordmark) and the floating action dock
// (music toggle, share, add-to-calendar ICS download).
import { useRef, useState } from "react";
import { FloralFlourish, ON_GOLD } from "../inviteShared.jsx";

export function InviteFooter({ theme, font, lang }) {
  return (
...
export function FloatingDock({ theme, lang, fixed, weddingDate, groomName, brideName, venue, venueAddress, showMusic, musicUrl }) {
