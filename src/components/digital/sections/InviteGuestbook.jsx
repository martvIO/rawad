// Guestbook — wish submission form + auto-rotating carousel of approved guest
// wishes and the groom's authored wishes.
import { useEffect, useMemo, useState } from "react";
import { SectionHead, ON_GOLD } from "../inviteShared.jsx";

export function GuestbookSection({ wishes, approvedWishes = [], onSubmitWish, theme, font, lang, disabled }) {
