// Hero of the digital invitation — crest monogram, couple names, dateline,
// guest greeting, optional featured media, scroll cue.
import { Num } from "../../Num.jsx";
import { BrandLogo } from "../../BrandLogo.jsx";
import { FloralFlourish } from "../inviteShared.jsx";

export function Hero({ guestName, groomName, brideName, monogram, eyebrow, dateText, venueLine, heroMedia = [], theme, font, lang }) {
  return (
