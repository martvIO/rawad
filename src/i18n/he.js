...
export const he = {
  ...
  price_pkg2_sub: "כל מה שבחבילה הראשונה — ועוד. לאירועים הראויים לחוויה שלמה שלא משאירה דבר ליד המקרה.",
  price_pkg2_bullets: [
  ...
  terms_intro: "ברוכים הבאים לדעוה. השימוש בפלטפורמה שלנו מהווה הסכמה לתנאים הבאים. אנא קראו אותם בעיון.",
  terms_sections: [
    {
      title: "1. השירות",
      body: "דעוה היא פלטפורמה לארגון וחלוקת הזמנות לחתונות — מודפסות ודיגיטליות — בישראל. אנו מספקים ניהול רשימת מוזמנים, חלוקת הזמנות, ושליחת הזמנות דיגיטליות בוואטסאפ."
    },
    {
      title: "2. החשבון והשימוש",
      body: "החתן אחראי על דיוק נתוני המוזמנים (שמות, מספרים, כתובות). הלקוח מתחייב לא להשתמש בפלטפורמה למטרות לא חוקיות או לשליחת תוכן פוגעני."
    },
    {
      title: "3. תשלום ומחירים",
      body: "המחירים המוצגים ניתנים להתאמה לפי מספר ההזמנות והאזור הגיאוגרפי. התשלום מתבצע לפני תחילת החלוקה. אין החזרים לאחר תחילת תהליך החלוקה."
    },
    {
      title: "4. חלוקה ומסירה",
      body: "אנו מתחייבים לחלוקה תוך 24 שעות מאישור הרשימה במקרים רגילים. השליח מנסה למסור לפחות פעמיים לפני סגירה. תמונות אישור מסירה זמינות בפורטל החתן."
    },
    {
      title: "5. פרטיות והגנת מידע",
      body: "אנו מטפלים בנתוני המוזמנים בסודיות מוחלטת. איננו משתפים מספרי טלפון או כתובות עם צד שלישי. הנתונים נמחקים 90 יום לאחר סיום החתונה לבקשת הלקוח."
    },
    {
      title: "6. גבולות אחריות",
      body: "דעוה אינה אחראית לטעויות בנתונים שמסר החתן, או להיעדרות מוזמן מהכתובת. במקרה של תקלה טכנית, אנו מתחייבים לתיקון תוך 24 שעות."
    },
    {
      title: "7. יצירת קשר",
      body: "לכל שאלה או תלונה, צרו איתנו קשר במספר שירות הלקוחות או מפורטל החתן."
    },
  ],
