...
export const he = {
  ...
  price_vip_title: "הזמנות דיגיטליות", price_vip_normal: "המחיר הרגיל", price_vip_pitch: "חוויה יוקרתית שאין כדוגמתה",
  ...
  landing_eyebrow: "פלטפורמה שמשרתת חתנים מאז 2023",
  scroll_cue: "גלול לגלות",
  trust_chips: ["+200 חתונות", "תוך 48 שעות", "מעקב חי", "במדים רשמיים"],
  about_eyebrow: "AS FEATURED",
  about_quote: "הפלטפורמה שהכי הרבה חתנים העריכו את הזמן שלהם השנה.",
  about_attrib: "— הלקוחות שלנו, 2026",
  features_eyebrow: "FEATURES",
  features_sub: "כל פרט נחשב — מהרשימה עד ההזמנה האחרונה.",
  stats_items: [
    { v: 200,  s: "+", l: "חתונות שטופלו" },
    { v: 48,   s: "ש", l: "זמן חלוקה ממוצע" },
    { v: 4.9,  s: "★", l: "דירוג חתנים", dec: 1 },
    { v: 99,   s: "%", l: "אחוז הגעה" },
  ],
  ...
  testimonials_title: "מה אומרים החתנים",
  testimonials: [
    { name: "רוואד ח'",    city: "חיפה", quote: "עבדתי איתם לחתונה שלי, אין מילים — שקט מוחלט. כל הזמנה הגיעה עם תמונה ומיקום." },
    { name: "כרים ע.",     city: "נצרת", quote: "רציתי לחלק 300 הזמנות לבד. צחקתי כשראיתי שדעוה עושה הכל. חסך לי שבוע שלם." },
    { name: "מוחמד וליה",  city: "עכו",  quote: "ההזמנה המלכותית VIP הייתה מדהימה. האורחים אמרו שזו ההזמנה הכי יוקרתית שקיבלו." },
  ],
  faq_eyebrow: "FAQ",
  ...
  footer_cols: {
    product:   { title: "המוצר",     items: ["השירותים", "מחירים", "Premium vs VIP", "דמו"] },
    company:   { title: "החברה",     items: ["עלינו", "המלצות", "צור קשר", "קריירה"] },
    resources: { title: "משאבים",    items: ["מדריך החתן", "הצטרפות מחלקים", "בלוג", "שאלות נפוצות"] },
    legal:     { title: "תקנון",     items: ["תנאים", "פרטיות", "עוגיות"] },
  },
