...
export const ar = {
  ...
  terms_intro: "مرحباً بك في دعوة. باستخدامك لمنصتنا، أنت توافق على الشروط التالية. يرجى قراءتها بعناية.",
  terms_sections: [
    {
      title: "1. الخدمة",
      body: "دعوة منصة لتنظيم وتوزيع دعوات الأفراح — ورقية ورقمية — في إسرائيل. نوفّر إدارة قائمة المدعوين، توزيع المكاتيب، وإرسال الدعوات الرقمية عبر واتساب."
    },
    {
      title: "2. الحساب والاستخدام",
      body: "العريس مسؤول عن دقة بيانات المدعوين (الأسماء، الأرقام، العناوين). يلتزم العميل بعدم استخدام المنصة لأي غرض غير مشروع أو إرسال محتوى مسيء."
    },
    {
      title: "3. الدفع والأسعار",
      body: "الأسعار المعروضة قابلة للتعديل حسب عدد الدعوات والمنطقة الجغرافية. الدفع يكون قبل بدء التوزيع. لا يتم استرداد المبالغ بعد بدء عملية التوزيع."
    },
    {
      title: "4. التوزيع والتسليم",
      body: "نلتزم بالتوزيع خلال 24 ساعة من تأكيد القائمة في الحالات العادية. الموزع يحاول التسليم مرتين على الأقل قبل الإغلاق. صور إثبات التسليم متوفرة في بوابة العريس."
    },
    {
      title: "5. الخصوصية وحماية البيانات",
      body: "نتعامل مع بيانات المدعوين بسرية تامة. لا نشارك أرقام الهواتف أو العناوين مع أي طرف ثالث. البيانات تُحذف بعد 90 يوم من انتهاء العرس بناءً على طلب العميل."
    },
    {
      title: "6. حدود المسؤولية",
      body: "دعوة غير مسؤولة عن أي خطأ في البيانات المقدمة من العريس، أو عن عدم تواجد المدعو في العنوان. في حال أي خلل تقني، نلتزم بالإصلاح خلال 24 ساعة."
    },
    {
      title: "7. التواصل",
      body: "لأي استفسار أو شكوى، تواصل معنا عبر رقم خدمة العملاء أو من بوابة العريس."
    },
  ],
